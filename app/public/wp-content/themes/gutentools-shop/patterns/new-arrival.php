...
/**
 * Title: New Arrival
 * Slug: gutentools-shop/new-arrival
 * Categories: gutentools-shop
 * Keywords: new-arrival
 * Block Types: core/post-content
 * Post Types: page, wp_template
 */
?>
<!-- wp:group {"style":{"spacing":{"padding":{"right":"20px","left":"20px","top":"100px","bottom":"100px"},"margin":{"top":"0","bottom":"0"}},"color":{"background":"#f2f6f7"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group has-background" style="background-color:#f2f6f7;margin-top:0;margin-bottom:0;padding-top:100px;padding-right:20px;padding-bottom:100px;padding-left:20px"><!-- wp:group {"style":{"spacing":{"margin":{"top":"0","bottom":"0"},"padding":{"bottom":"60px"},"blockGap":"var:preset|spacing|20"}},"layout":{"type":"constrained","contentSize":"800px"}} -->
...
<p class="has-text-align-center has-text-color has-link-color" style="color:#017a50;text-transform:uppercase"><strong><?php echo esc_html__( 'recently arrived', 'gutentools-shop' ); ?></strong></p>
<!-- /wp:paragraph -->
...
<h2 class="wp-block-heading has-text-align-center" style="margin-top:0;margin-bottom:0;font-size:42px;font-style:normal;font-weight:400;letter-spacing:2px;line-height:1.1"><?php echo esc_html__( 'New Arrival', 'gutentools-shop' ); ?></h2>
<!-- /wp:heading -->
...
<!-- wp:group {"style":{"spacing":{"margin":{"top":"0","bottom":"0"},"padding":{"top":"18px","bottom":"18px","left":"18px","right":"18px"},"blockGap":"var:preset|spacing|20"},"border":{"radius":{"bottomLeft":"8px","bottomRight":"8px","topRight":"0px","topLeft":"0px"}}},"backgroundColor":"white","layout":{"type":"constrained"}} -->
<div class="wp-block-group has-white-background-color has-background" style="border-top-left-radius:0px;border-top-right-radius:0px;border-bottom-left-radius:8px;border-bottom-right-radius:8px;margin-top:0;margin-bottom:0;padding-top:18px;padding-right:18px;padding-bottom:18px;padding-left:18px"><!-- wp:post-terms {"term":"category","textAlign":"center"} /-->
