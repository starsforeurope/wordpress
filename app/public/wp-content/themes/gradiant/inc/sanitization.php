 ...
 */
function gradiant_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function gradiant_sanitize_html( $html ) {
 ...
 */
function gradiant_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function gradiant_sanitize_range_value( $number, $setting ) {
 ...
 */
function gradiant_sanitize_select( $input, $setting ) {
 ...
 */
function gradiant_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function gradiant_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function gradiant_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}