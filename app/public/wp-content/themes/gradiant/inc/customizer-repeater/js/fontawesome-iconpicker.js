(function ($) {
    ...
    wp.gradiantcustomizerRepeater = {
        ...
        init: function () {
            $('.iconpicker-items>i').on('click', function () {
                ...
                gradiant_customizer_repeater_refresh_social_icons(th);
                return false;
            });
        },
    ...
    $(document).ready(function () {
        wp.gradiantcustomizerRepeater.init();

        $('.iconpicker-search').on('keyup', function () {
            wp.gradiantcustomizerRepeater.search($(this));
        });

        $('.icp-auto').on('click', function () {
            wp.gradiantcustomizerRepeater.iconPickerToggle($(this));
        });
