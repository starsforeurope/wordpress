...
jQuery(document).ready(function () {
    ...
    gradiant_theme_controls.on('click', '.customizer-repeater-new-field', function () {
        ...
        {
        if(jQuery('#exist_gradiant_Menus').val()>=2)
        {
        ...
        return false;   
         ...
         if(jQuery('#exist_gradiant_Menus').val()<2)
        {
         var new_service_add_val=parseInt(jQuery('#exist_gradiant_Menus').val())+1;
         jQuery('#exist_gradiant_Menus').val(new_service_add_val);  
        }
        }
		
		if(split_add_more_button_split=="Add New Clie")
        {
        if(jQuery('#exist_gradiant_Client').val()>=5)
        {
        ...
        return false;   
         ...
         if(jQuery('#exist_gradiant_Client').val()<5)
        {
         var new_service_add_val=parseInt(jQuery('#exist_gradiant_Client').val())+1;
         jQuery('#exist_gradiant_Client').val(new_service_add_val);  
        }
        }
    ...
    gradiant_theme_controls.on('click', '.social-repeater-general-control-remove-field', function () {
        ...
        if (typeof    jQuery(this).parent() !== 'undefined') {
            jQuery(this).parent().hide(500, function(){
                ...
                {
                jQuery('#exist_gradiant_Menus').val(parseInt(jQuery('#exist_gradiant_Menus').val())-1); 
                }
				if(split_delete_button_split=="Delete Clien")
                {
                jQuery('#exist_gradiant_Client').val(parseInt(jQuery('#exist_gradiant_Client').val())-1); 
                }
