 ...
 *
 * @package     Gradiant
 * @copyright   Copyright (c) 2022, Gradiant
 * @since       1.0
 */
...
class Gradiant_Icon_Picker_Control extends WP_Customize_Control
{

  private $icons = false;

  public function __construct( $manager, $id, $args = array(), $options = array() ) {
    $this->icons = $this->Gradiant_get_icons();
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'fonticonpicker-css', GRADIANT_PARENT_URI . '/assets/fonticonpicker/jquery.fonticonpicker.min.css', false );
			 
		wp_enqueue_script( 'fonticonpicker-js', GRADIANT_PARENT_URI .'/assets/fonticonpicker/jquery.fonticonpicker.min.js', array( 'jquery', 'jquery-ui-sortable' ) );
	}
